...
class Ui_ToolBar(object):
    def setupUi(self, ToolBar):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/stuff/view_books.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.books_btn.setIcon(icon6)
        self.books_btn.setIconSize(QtCore.QSize(48, 48))
        self.books_btn.setCheckable(True)
        self.books_btn.setAutoExclusive(True)
        self.books_btn.setPopupMode(QtGui.QToolButton.DelayedPopup)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/stuff/view_highlights.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.highlights_btn.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/stuff/logo48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
