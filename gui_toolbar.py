...
class Ui_ToolBar(object):
    def setupUi(self, ToolBar):
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/stuff/view_db.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.db_btn.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/stuff/logo64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.about_btn.setIcon(icon10)
...
"Activated only if two entries of the same book are selected.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.db_btn.setToolTip(QtGui.QApplication.translate("ToolBar", "Archive View", None, QtGui.QApplication.UnicodeUTF8))
        self.db_btn.setStatusTip(QtGui.QApplication.translate("ToolBar", "Archive View", None, QtGui.QApplication.UnicodeUTF8))
        self.db_btn.setText(QtGui.QApplication.translate("ToolBar", "Archive", None, QtGui.QApplication.UnicodeUTF8))
