...
#
# Created: Sat Mar 30 23:59:38 2019
...
class Ui_ToolBar(object):
    def setupUi(self, ToolBar):
        ...
        self.view_frame = QtGui.QGroupBox(self.tool_frame)
        ...
        self.loaded_btn = QtGui.QToolButton(self.view_frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.loaded_btn.setIcon(icon7)
        self.loaded_btn.setIconSize(QtCore.QSize(48, 48))
        self.loaded_btn.setCheckable(True)
        self.loaded_btn.setAutoExclusive(True)
        self.loaded_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.loaded_btn.setAutoRaise(True)
        self.loaded_btn.setObjectName("loaded_btn")
        self.horizontalLayout_3.addWidget(self.loaded_btn)
        self.db_btn = QtGui.QToolButton(self.view_frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/stuff/view_db.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.db_btn.setIcon(icon8)
        self.db_btn.setIconSize(QtCore.QSize(48, 48))
        self.db_btn.setCheckable(True)
        self.db_btn.setAutoExclusive(True)
        self.db_btn.setPopupMode(QtGui.QToolButton.DelayedPopup)
        self.db_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.db_btn.setAutoRaise(True)
        self.db_btn.setObjectName("db_btn")
        self.horizontalLayout_3.addWidget(self.db_btn)
        self.view_grp = QtGui.QGroupBox(self.view_frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.view_grp.sizePolicy().hasHeightForWidth())
        self.view_grp.setSizePolicy(sizePolicy)
        self.view_grp.setObjectName("view_grp")
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.view_grp)
        ...
        self.books_view_btn.setIcon(icon9)
        self.books_view_btn.setIconSize(QtCore.QSize(24, 24))
        self.books_view_btn.setCheckable(True)
        self.books_view_btn.setChecked(True)
        self.books_view_btn.setAutoExclusive(True)
        self.books_view_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.books_view_btn.setAutoRaise(True)
        self.books_view_btn.setObjectName("books_view_btn")
        self.verticalLayout_2.addWidget(self.books_view_btn)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/stuff/highlights.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.high_view_btn.setIcon(icon10)
        self.high_view_btn.setIconSize(QtCore.QSize(24, 24))
        self.high_view_btn.setCheckable(True)
        self.high_view_btn.setAutoExclusive(True)
        self.high_view_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.high_view_btn.setAutoRaise(True)
        self.high_view_btn.setObjectName("high_view_btn")
        self.verticalLayout_2.addWidget(self.high_view_btn)
        self.horizontalLayout_3.addWidget(self.view_grp)
        ...
        self.horizontalLayout_4.addWidget(self.tool_frame)
