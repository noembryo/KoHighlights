...
class Ui_ToolBar(object):
    def setupUi(self, ToolBar):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/stuff/file_info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/stuff/trash.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/stuff/logo48.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/stuff/quit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"Can also be the reader\'s root directory (Ctrl+O)", None, QtGui.QApplication.UnicodeUTF8))
        self.select_btn.setStatusTip(QtGui.QApplication.translate("ToolBar", "Scans a directory for Koreader history files. Can also be the reader\'s root directory (Ctrl+O)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.info_btn.setToolTip(QtGui.QApplication.translate("ToolBar", "View more info about the selected book (Ctrl+I)", None, QtGui.QApplication.UnicodeUTF8))
        self.info_btn.setStatusTip(QtGui.QApplication.translate("ToolBar", "View more info about the selected book (Ctrl+I)", None, QtGui.QApplication.UnicodeUTF8))
        self.info_btn.setText(QtGui.QApplication.translate("ToolBar", "Book Info", None, QtGui.QApplication.UnicodeUTF8))
        self.clear_btn.setToolTip(QtGui.QApplication.translate("ToolBar", "Clears the books list (Ctrl+Del)", None, QtGui.QApplication.UnicodeUTF8))
        self.clear_btn.setStatusTip(QtGui.QApplication.translate("ToolBar", "Clears the books list (Ctrl+Del)", None, QtGui.QApplication.UnicodeUTF8))
