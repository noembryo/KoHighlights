...
#
# Created: Thu Mar  7 01:13:13 2019
...
class Ui_ToolBar(object):
    def setupUi(self, ToolBar):
        ...
        self.select_btn = QtGui.QToolButton(self.tool_frame)
        ...
        self.save_btn = QtGui.QToolButton(self.tool_frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/stuff/logo64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
